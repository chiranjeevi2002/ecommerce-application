...
(2001, 'Red Rose Bouquet (20 stems)',  'Classic red roses with fillers',                 799.00, 100, 211, true, 1102, CURRENT_TIMESTAMP()),
(2002, 'Pink Lily Bouquet',            'Hand-tied bouquet with pink lilies',            999.00, 60,  211, true, 1103, CURRENT_TIMESTAMP()),
(2003, 'Mixed Flower Basket',          'Colourful mix of seasonal flowers',             1199.00,80,  211, true, 1101, CURRENT_TIMESTAMP()),
(2004, 'Money Plant in Ceramic Pot',   'Indoor air-purifying plant',                    499.00, 50,  211, true, 1104, CURRENT_TIMESTAMP()),
(2005, 'Lucky Bamboo (3 Layer)',       'Vastu friendly lucky bamboo plant',            399.00,  70,  211, true, 1104, CURRENT_TIMESTAMP()),
(2006, 'Rose & Dairy Milk Combo',      'Red roses with chocolates',                    899.00,  40,  211, true, 1105, CURRENT_TIMESTAMP()),
(2007, 'Anniversary Special Bouquet',  'Premium bouquet for anniversaries',            1499.00,30,  211, true, 1101, CURRENT_TIMESTAMP()),
(2008, 'Yellow Roses Bunch (12)',      'Bright yellow roses for friendship',           649.00,  80,  211, true, 1102, CURRENT_TIMESTAMP()),
(2009, 'Office Desk Plant Set',        'Set of 3 mini plants for desk',                1299.00,25,  211, true, 1104, CURRENT_TIMESTAMP()),
(2010, 'Birthday Flower Combo',        'Flowers with greeting card',                   999.00,  45,  211, true, 1105, CURRENT_TIMESTAMP());
...
------------------------------------------------------------
INSERT INTO products (id, name, description, price, quantity, store_id, active, category_id, created_at) VALUES
(2101, 'Paracetamol 500mg (Strip of 10)', 'Pain and fever reducer tablets',         35.00,  500, 212, true, 1201, CURRENT_TIMESTAMP()),
(2102, 'Ibuprofen 400mg (Strip of 10)',    'Anti-inflammatory and pain reliever',    55.00,  400, 212, true, 1201, CURRENT_TIMESTAMP()),
(2103, 'Cough Syrup 100ml',                'Relief from dry and wet cough',         110.00, 300, 212, true, 1202, CURRENT_TIMESTAMP()),
(2104, 'Vitamin C 500mg (30 tabs)',        'Boosts immunity and skin health',       199.00, 200, 212, true, 1203, CURRENT_TIMESTAMP()),
(2105, 'Multivitamin Tablets (30 tabs)',   'Daily multivitamin supplement',         249.00, 200, 212, true, 1203, CURRENT_TIMESTAMP()),
(2106, 'First Aid Kit Basic',              'Essential first aid supplies',          399.00, 80,  212, true, 1204, CURRENT_TIMESTAMP()),
(2107, 'Digital Thermometer',              'Fast and accurate temperature reading', 299.00, 120, 212, true, 1204, CURRENT_TIMESTAMP()),
(2108, 'Hand Sanitizer 500ml',             'Alcohol-based sanitizer',               149.00, 250, 212, true, 1205, CURRENT_TIMESTAMP()),
(2109, 'Antiseptic Liquid 100ml',          'For minor cuts and wounds',             75.00,  200, 212, true, 1204, CURRENT_TIMESTAMP()),
(2110, 'Moisturizing Lotion 200ml',        'Daily body moisturizer',                220.00, 150, 212, true, 1205, CURRENT_TIMESTAMP());
...
------------------------------------------------------------
INSERT INTO products (id, name, description, price, quantity, store_id, active, category_id, created_at) VALUES
(2201, 'Bananas (1 Dozen)',           'Fresh Cavendish bananas',            60.00,  120, 213, true, 1301, CURRENT_TIMESTAMP()),
(2202, 'Tomatoes (1 kg)',            'Fresh red tomatoes',                 45.00,  100, 213, true, 1301, CURRENT_TIMESTAMP()),
(2203, 'Full Cream Milk (1 L)',      'Packaged full cream milk',           72.00,  200, 213, true, 1302, CURRENT_TIMESTAMP()),
(2204, 'Curd (500 g)',               'Fresh dairy curd',                   45.00,  150, 213, true, 1302, CURRENT_TIMESTAMP()),
(2205, 'Potato Chips (Large Pack)',  'Classic salted potato chips',        99.00,  180, 213, true, 1303, CURRENT_TIMESTAMP()),
(2206, 'Chocolate Cookies (Pack)',   'Choco-chip cookies',                 80.00,  160, 213, true, 1303, CURRENT_TIMESTAMP()),
(2207, 'Orange Juice (1 L)',         'Packed fruit beverage',              120.00, 130, 213, true, 1304, CURRENT_TIMESTAMP()),
(2208, 'Tea Powder (500 g)',         'Strong Assam tea blend',             210.00, 90,  213, true, 1304, CURRENT_TIMESTAMP()),
(2209, 'Basmati Rice (5 kg)',        'Premium long-grain Basmati rice',    599.00, 70,  213, true, 1305, CURRENT_TIMESTAMP()),
(2210, 'Sunflower Oil (1 L)',        'Refined sunflower cooking oil',      155.00, 100, 213, true, 1305, CURRENT_TIMESTAMP());
...
------------------------------------------------------------
INSERT INTO products (id, name, description, price, quantity, store_id, active, category_id, created_at) VALUES
(2301, 'Smartphone X 128GB',          '6.5" display, 128GB storage, 5G',       24999.00, 50, 214, true, 1401, CURRENT_TIMESTAMP()),
(2302, 'Smartphone Y 64GB',           '6.1" display, 64GB storage, 4G',        17999.00, 80, 214, true, 1401, CURRENT_TIMESTAMP()),
(2303, 'Laptop Pro 14"',              '14" laptop, 16GB RAM, 512GB SSD',       74999.00, 30, 214, true, 1402, CURRENT_TIMESTAMP()),
(2304, 'Laptop Air 13"',              '13" lightweight laptop, 8GB RAM',       55999.00, 40, 214, true, 1402, CURRENT_TIMESTAMP()),
(2305, 'Wireless Headphones',         'Over-ear wireless headphones',          2999.00,  120,214, true, 1403, CURRENT_TIMESTAMP()),
(2306, 'Bluetooth Earbuds',           'True wireless earbuds with case',       1999.00,  150,214, true, 1403, CURRENT_TIMESTAMP()),
(2307, 'Smart LED TV 43"',            '43-inch 4K smart LED TV',               32999.00, 20, 214, true, 1404, CURRENT_TIMESTAMP()),
(2308, 'Smart LED TV 55"',            '55-inch 4K smart LED TV',               49999.00, 15, 214, true, 1404, CURRENT_TIMESTAMP()),
(2309, 'Microwave Oven 23L',          '23L convection microwave oven',         10999.00, 25, 214, true, 1405, CURRENT_TIMESTAMP()),
(2310, 'Front Load Washing Machine',  '6kg front-load washing machine',        25999.00, 18, 214, true, 1405, CURRENT_TIMESTAMP());
