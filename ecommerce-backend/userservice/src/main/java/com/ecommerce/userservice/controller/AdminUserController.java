...
@AdminOnly
@RestController
@RequestMapping(SecurityConstants.ADMIN_USERS_BASE)
public class AdminUserController {
	...
	@PutMapping("/{id}/roles")
	public ResponseEntity<UserResponse> updateRoles(@PathVariable Long id, @RequestParam(required = false) Long storeId,
			@RequestBody List<String> roles) {
		return ResponseEntity.ok(adminService.updateUserRoles(id, roles, storeId));
	}
